<!--ESTE ES EL ENCARGADO DE MOSTRAR EN EL DOCUMENTO LOS DATOS QUE CONTIENE LA BASE DE DATOS-->
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="col">
      ...
      <p class="">Edad: <?php echo $data['fenac'] ?> <a class="btn btn-primary"><span class="badge badge-pill badge-success"> <?php echo edadPersona($data['fenac']); ?></span></a></p>
